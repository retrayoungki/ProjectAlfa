...
export const DEFAULT_WBS_TEMPLATE = [
  { category: 'Preliminaries', order: 0 },
  { category: 'Ceiling', order: 1 },
  { category: 'Wall', order: 2 },
  { category: 'MEP', order: 3 },
  { category: 'Flooring', order: 4 },
  { category: 'Finishing', order: 5 },
  { category: 'Signage', order: 6 },
  { category: 'Others', order: 7 },
];
