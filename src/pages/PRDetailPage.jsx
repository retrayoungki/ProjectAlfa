...
const PRDetailPage = ({ currentUser, systemUsers = [] }) => {
  ...
  const handleDecision = (decision) => {
    ...
    setTimeout(() => {
      const updated = applyApproval(pr.refNo, currentUser, decision, comment, systemUsers)
      if (updated) {
        setPr({ ...updated })
  ...
  const handlePayment = () => {
    ...
    setTimeout(() => {
      const updated = applyPayment(pr.refNo, currentUser, comment)
      if (updated) {
        setPr({ ...updated })
...
const PaymentStep = ({ payment, locked }) => {
